<x-practice2.layout section="brands">
  {{-- <a href="{{route('practice2.brands.create')}}" class="bg-blue-600 text-white px-2 py-1 inline-block rounded-md mb-2 active:bg-blue-700">Create</a> --}}
        ...
        <tr>
          ...
          <td class="p-2 border-l border-gray-200">
            <div class="flex items-center justify-center gap-x-3">
              <a href="{{route('practice2.brands.show', [$brand])}}" class="w-6 h-6 flex justify-center items-center rounded shadow-md fill-blue-600 active:bg-blue-600 active:fill-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-4">
                  <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z"/>
                </svg>
              </a>
              <a href="{{route('practice2.brands.edit', [$brand])}}" class="w-6 h-6 flex justify-center items-center rounded shadow-md fill-blue-600 active:bg-blue-600 active:fill-white">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="h-4">
              ...
              <form action="{{route('practice2.brands.destroy', [$brand])}}" method="POST" class="w-6 h-6 rounded shadow-md fill-red-500 active:bg-red-500 active:fill-white">
                @csrf
                @method('DELETE')
      ...
      <form action="{{route('practice2.brands.store')}}" method="POST">
        <td class="p-2">
          <div class="flex flex-col">
            <input type="text" name="brand" class="bg-gray-100 rounded-md p-1 outline-none focus:ring-1 focus:ring-gray-300" placeholder="Brand" value="{{old('brand')}}">
            @error('brand')
              <i>{{$message}}</i>
            @enderror
          </div>
